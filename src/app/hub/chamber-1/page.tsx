...
export default function ChamberOne() {
  ...
  return (
    <div className="min-h-screen bg-obsidian text-bone overflow-x-hidden selection:bg-blood">
      ...
      {/* Main Content Area */}
      <main className="relative min-h-screen flex flex-col items-center justify-center px-6 py-24" onClick={advance}>
        ...
        <div className="max-w-2xl w-full mx-auto relative z-10 cursor-pointer">
          <AnimatePresence mode="wait">
            
            {/* Phase 0: The Hook (Relatable) */}
            {phase === 0 && (
              <motion.div
                key="phase-0"
            ...
            {phase === 1 && (
              <motion.div
                ...
                className="space-y-12"
              >
                <div className="w-px h-24 bg-gradient-to-b from-transparent via-blood/50 to-transparent mx-auto"></div>
                
                <h2 className="font-serif text-2xl md:text-4xl leading-tight text-center text-crimson">
                  But if you can hear the voice...
                </h2>
                
                <div className="space-y-8 text-ash/80 font-light font-sans text-lg md:text-xl leading-relaxed text-center">
                  <p>Then who is the one listening?</p>
                  <div className="p-8 border border-ash/10 bg-black/40 backdrop-blur-sm relative">
                    ...
                    <p className="text-xs uppercase tracking-widest text-ash/40 mt-4">— Meister Eckhart</p>
                  </div>
                  <p>The identity you defend so fiercely is nothing more than accumulated memory, societal conditioning, and survival instincts running on a loop.</p>
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <p className="font-sans font-light text-ash/70 text-lg">
                    You are not the thoughts. You are the empty space in which the thoughts appear.
                  </p>
                  <p className="font-sans font-light text-ash/70 text-lg">
                    This space is untouched by anxiety. It cannot be insulted. It cannot die.
                  </p>
                </div>
              </motion.div>
            )}

            {/* Phase 3: Conclusion / Exit */}
            {phase === 3 && (
              <motion.div
                key="phase-3"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <div className="max-w-md mx-auto text-left border-l border-crimson/50 pl-6 py-2 space-y-4">
                  <p className="font-sans font-light text-ash/80">
                    <span className="text-bone font-medium">Task:</span> For the next 24 hours, whenever you feel frustration, do not say &quot;I am frustrated.&quot; 
                  </p>
                  <p className="font-sans font-light text-ash/80">
                    Say instead: <span className="italic text-bone">&quot;I am observing the sensation of frustration.&quot;</span>
                  </p>

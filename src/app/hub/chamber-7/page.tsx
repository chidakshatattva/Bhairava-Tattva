...
export default function ChamberSeven() {
    ...
    <div className="min-h-screen bg-obsidian text-bone overflow-x-hidden selection:bg-blood flex flex-col relative">
      <header className="fixed top-0 left-0 w-full p-6 md:p-8 z-50 flex justify-between items-center mix-blend-difference pointer-events-none">
        ...
        <div className="font-sans text-[10px] uppercase tracking-[0.3em] text-ash/40">
          Chamber VII: Collapse of Separation
        </div>
      </header>
        ...
        <div className="max-w-3xl w-full mx-auto relative z-10 cursor-pointer">
          <AnimatePresence mode="wait">
            ...
            {phase === 0 && (
              ...
              >
                <Activity className="w-12 h-12 text-blood mx-auto opacity-60" />
                ...
                <div className="space-y-6 text-ash/80 font-light font-sans text-lg md:text-xl leading-relaxed">
                  <p>In deep states of focus, the boundary between "you" and "the task" vanishes.</p>
                  <p>The runner becomes the run. The artist becomes the canvas.</p>
                  <p>This is not a metaphor. It is the literal collapse of the psychological boundary of self.</p>
                </div>
            ...
            {phase === 1 && (
              ...
              >
                ...
                <div className="space-y-8 text-ash/80 font-light font-sans text-lg md:text-xl leading-relaxed text-left border-l border-ash/10 pl-6">
                  <p><span className="text-bone font-medium text-sm tracking-widest uppercase">Scientific Perspective:</span> Flow states are characterized by transient hypofrontality—the temporary deactivation of the prefrontal cortex, the area responsible for self-monitoring and ego.</p>
                  <p><span className="text-bone font-medium text-sm tracking-widest uppercase">Spiritual Perspective:</span> Unity consciousness is the permanent realization that the boundary of skin does not separate you from the universe.</p>
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                <div className="max-w-md mx-auto text-left border-l border-crimson/50 pl-6 py-2 space-y-4">
                  <p className="font-sans font-light text-ash/80">
                    <span className="text-bone font-medium">Task:</span> Listen to the ambient sound in the room right now.
                  </p>
                  <p className="font-sans font-light text-ash/80">
                    Try to locate the exact point where the sound "out there" turns into the experience of hearing "in here." You cannot find it.
                  </p>
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                <div className="space-y-8">
                  <p className="font-serif text-xl italic text-bone/90 max-w-lg mx-auto">
                    "When do you feel most 'in the zone' or connected to something larger than yourself? What does the absence of 'you' feel like in those moments?"
                  </p>
      ...
      <JournalModal
        chamber="Chamber VII: Collapse of Separation"
        prompt="When do you feel most 'in the zone' or connected to something larger than yourself? What does the absence of 'you' feel like in those moments?"
